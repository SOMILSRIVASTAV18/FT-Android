              ...
              <Dialog open={isEditProfileOpen} onOpenChange={setIsEditProfileOpen}>
                ...
                <DialogContent className="glass border-none shadow-2xl rounded-[2.5rem]">
                  ...
                  <div className="space-y-4 py-4">
                    ...
                    <div className="space-y-2">
                      <Label className="text-xs font-bold uppercase tracking-wider ml-1">Personal UPI ID (Account QR)</Label>
                      <Input 
                        value={upiId} 
                      ...
                      />
                      <p className="text-[11px] text-muted-foreground ml-1">This UPI ID is unique to your account and generates your personal QR code.</p>
                    </div>
