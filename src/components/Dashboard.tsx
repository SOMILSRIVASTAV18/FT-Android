    ...
    >
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-4 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-muted-foreground text-[10px] md:text-sm font-medium uppercase tracking-widest opacity-80">Welcome back to FinTrack Hub</p>
          </div>
        </div>
        <Button 
          variant="outline" 
          ...
          className="rounded-full border-primary/20 bg-primary/5 text-primary font-bold shrink-0 h-9 md:h-11 px-4 md:px-6 shadow-sm hover:shadow-md transition-all active:scale-95"
        >
          <Users className="mr-1.5 md:mr-2 h-4 w-4" />
          <span className="text-xs md:text-sm uppercase tracking-widest">Family</span>
        </Button>
      </div>
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-4 gap-2 md:gap-4">
        {[
          ...
          >
            <div className={cn(
              "w-12 h-12 md:w-14 md:h-14 rounded-2xl flex items-center justify-center text-white shadow-lg transition-transform group-active:scale-90",
              action.color
            )}>
              <action.icon className="h-5 w-5 md:h-6 md:w-6" />
            </div>
            <span className="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-muted-foreground">{action.label}</span>
          </button>
        ))}
      </motion.div>
